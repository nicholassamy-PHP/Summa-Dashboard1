    ...
    <div className={`card-premium p-6 border-l-4 border-l-blue-500`}>
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-slate-400 font-medium mt-2">Driver: <span className="text-slate-300">{shipment.driver_name}</span></p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6 p-4 bg-slate-700/30 rounded-xl border border-slate-600/50">
        <div>
          ...
          <p className="text-xs text-slate-400">{shipment.origin.country}</p>
        </div>
        <div>
          ...
          <p className="text-xs text-slate-400">{shipment.destination.country}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        ...
        <div className="bg-slate-700/30 rounded-lg p-3 border border-slate-600/50">
          <p className="text-xs text-slate-500 font-semibold">Speed</p>
